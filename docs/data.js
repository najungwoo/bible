const DEFAULT_DATA = {
    ...
    "대집회 2일차 3일차(5월 암송)": [
        ...
        "(유 1:7)^소돔과 고모라와 그 이웃 도시들도 저희와 같은 모양으로 간음을 행하며 다른 색을 따라 가다가 영원한 불의형벌을 받음으로 거울이 되었느니라",
        ...
        "(창 12:1-3)^여호와께서 아브람에게 이르시되 너는 너의 본토 친척 아비 집을 떠나 내가 네게 지시할 땅으로 가라 2 내가 너로 큰 민족을 이루고 네게 복을 주어 네 이름을 창대케 하리니 너는 복의 근원이 될지라 3 너를 축복하는 자에게는 내가 복을 내리고 너를 저주하는 자에게는 내가 저주하리니 땅의 모든 족속이 너를 인하여 복을 얻을 것이니라 하신지라",
        ...
        "(롬 3:1-2)^그런즉 유대인의 나음이 무엇이며 할례의 유익이 무엇이뇨 2 범사에 많으니 첫째는 저희가 하나님의 말씀을 맡았음이니라",

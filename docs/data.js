const DEFAULT_DATA = {
    ...
    "영혼.txt": [
        ...
        "1\\(창 2:7)^여호와 하나님이 흙으로 사람을 지으시고 생기를 그 코에 불어 넣으시니 사람이 생령이 된지라",
        "1\\(요 4:24)^하나님은 영이시니 예배하는 자가 신령과 진정으로 예배할찌니라",
        "1\\(겔 18:4)^모든 영혼이 다 내게 속한지라 아비의 영혼이 내게 속함 같이 아들의 영혼도 내게 속하였나니 범죄하는 그 영혼이 죽으리라",
        "1\\(전 3:11)^하나님이 모든 것을 지으시되 때를 따라 아름답게 하셨고 또 사람에게 영원을 사모하는 마음을 주셨느니라 그러나 하나님의 하시는 일의 시종을 사람으로 측량할 수 없게 하셨도다",
        "1\\(시 130:5)^나 곧 내 영혼이 여호와를 기다리며 내가 그 말씀을 바라는도다",
        "1\\(히 9:27)^한번 죽는 것은 사람에게 정하신 것이요 그 후에는 심판이 있으리니",
        "1\\(욥 19:26)^나의 이 가죽, 이것이 썩은 후에 내가 육체 밖에서 하나님을 보리라",
        "1\\(시 14:1-3)^어리석은 자는 그 마음에 이르기를 하나님이 없다 하도다 저희는 부패하고 소행이 가증하여 선을 행하는 자가 없도다 2 여호와께서 하늘에서 인생을 굽어 살피사 지각이 있어 하나님을 찾는 자가 있는가 보려 하신즉 3 다 치우쳤으며 함께 더러운 자가 되고 선을 행하는 자가 없으니 하나도 없도다",
        "1\\(전 3:20-21)^다 흙으로 말미암았으므로 다 흙으로 돌아가나니 다 한 곳으로 가거니와 21 인생의 혼은 위로 올라가고 짐승의 혼은 아래 곧 땅으로 내려가는 줄을 누가 알랴",
